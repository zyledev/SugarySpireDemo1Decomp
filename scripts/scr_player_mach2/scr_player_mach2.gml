function scr_player_mach2() //gml_Script_scr_player_mach2
{
    ...
    switch character
    {
        case "P":
            ...
            if (grounded && sprite_index != spr_player_machtumble)
            {
            ...
            if ((!grounded) && sprite_index != spr_secondjump2 && sprite_index != spr_mach2jump && sprite_index != spr_player_machtumble && sprite_index != spr_player_bump)
                sprite_index = spr_secondjump1
