...
if (bombreset > 0)
    bombreset--
if (obj_player.x > (x - 400) && obj_player.x < (x + 400) && y <= (obj_player.y + 60) && y >= (obj_player.y - 60) && obj_player.state != 100 && obj_player.state != (110 << 0) && obj_player.state != 71 && obj_player.state != 111 && obj_player.state != 112)
{
